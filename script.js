...
function mostrarApartado(id){
    ...
    document.getElementById('analisis-estructurado')
    .classList.add('activa');


    // =========================
    // OCULTAR SUBAPARTADOS
    // =========================

    let apartados =
    document.querySelectorAll('.subapartado');

    apartados.forEach(function(apartado){

        apartado.classList.remove('activo');
